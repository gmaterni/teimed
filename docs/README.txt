...
aggiuge il tag <l> per pgni riga  ed il tag  <w> per ogni parola
...
optional arguments:
  ...
  -t          [-t <file tags>] default:TEIMTAGS.csv
  -c          [-c <file.cnf>]

Gestisce in modalità visuale i programmi:
