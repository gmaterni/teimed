...
maketeimprj.py
        costruzione struttura progetto
...
teimedit.py
        programma integrato di editore

teimxml.py
    dal file testo <file>.txzt a  <file>_tei.txt
...
teimxmllint.py
    da file_id_over_noite.xml a file.xml formattato
    per file finali ben formati.
    utilizzato nel progetto del manoscritto
